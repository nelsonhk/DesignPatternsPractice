...
public class SatelliteUplink {
    ...
    /**
     * Default Constructor instantiates the SatelliteUplink class with {@link SatConnDummy} which returns dummy data.
     */
     ...
     * </ul>
     *
     * If none of these conditions are met, {@link #checkNearbyAreaStorms()} is called to check if nearby
     * areas (via satellite) have issued a storm warning. If so, a storm warning will be suggested.
     *
     * <p><b>Dummy Data</b>
     * <p>currentData returns the following:
     * <ul>
     *     <li>Humidity: 30</li>
    ...
    /**
     * <p>Averages all parameters passed with the corresponding satellite datum value.
     * Also checks the difference in air pressure against earlier readings (earlier reading will be 800)
     ...
     *     <li>Humidity difference exceeds 5 AND wind speed average is greater than 15</li>
     * </ul>
     *
     * <p>If none of these conditions are met, {@link #checkNearbyAreaTornadoes()} is called to check if nearby
     * areas (via satellite) have issued a tornado warning. If so, a tornado warning will be suggested.
     *
     * <p><b>Dummy Data</b>
     * <p>currentData returns the following:
     * <ul>
     ...
     *     <li>Wind Speed: 15</li>
     * </ul>
     * <p>previousData returns the following:
     * <ul>
    ...
    /**
     * Calls the satellite to check if other nearby weather stations issued a tornado warning.
     *
     * <p><b>Dummy data always return true.</b>
     *
    ...
    /**
     * Calls the satellite to check if other nearby weather stations issued a storm warning.
     *
     * <p><b>Dummy data always return true.</b>
     *
